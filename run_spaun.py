...
parser.add_argument(
    '--nengo_dl', action='store_true',
    help='Supply to use the NengoDL backend (will override -b).')
...
for n in range(args.n):
    ...
    # ----- Initalize logger and write header data -----
